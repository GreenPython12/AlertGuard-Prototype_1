				...
				<div className="flex items-center self-stretch bg-[#CDDDFC] relative border border-solid border-[#5D88FF]">
					...
					<div className="flex flex-col shrink-0 items-start self-stretch bg-[#CDDDFC] absolute top-0 bottom-0 left-0 py-3 pl-[87px] pr-11 border border-solid border-[#5D88FF]">
						<div className="flex flex-col items-center relative">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/z5ozux8n_expires_30_days.png"} 
					...
					<button className="flex shrink-0 items-center bg-white text-left py-[9px] px-4 mr-[45px] gap-[15px] rounded-[10px] border-0"
						onClick={()=>alert("Pressed!")}>
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/z6d3aohk_expires_30_days.png"} 
					...
					<div className="flex justify-between items-center bg-white w-[198px] py-[1px] rounded-[10px]">
						<div className="flex flex-col items-start w-[66px] ml-[19px] gap-[7px]">
							...
							<div className="flex items-center self-stretch gap-1">
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/gj5e906y_expires_30_days.png"} 
						...
						<img
							src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/jqzki4b2_expires_30_days.png"} 
				...
				<div className="flex items-center self-stretch mr-[55px] gap-[22px]">
					<div className="bg-[#EDF3FF] w-[332px] pt-[30px] px-[15px]">
						<div className="flex items-center self-stretch bg-white mb-[30px] rounded-[10px]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/habsat1g_expires_30_days.png"} 
						...
						<div className="flex items-center self-stretch bg-white mb-[30px] rounded-[10px]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/b31bbot7_expires_30_days.png"} 
						...
						<div className="flex items-center self-stretch bg-white mb-[31px] rounded-[10px]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/8x7creiw_expires_30_days.png"} 
						...
						<div className="flex items-center self-stretch bg-white mb-[700px] rounded-[10px]">
							<img
								src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/6v5mtpy3_expires_30_days.png"} 
					...
					<div className="flex-1">
						<div className="flex items-center self-stretch mb-[26px]">
							<div className="flex flex-1 flex-col items-center bg-white py-6 mr-[15px] gap-[5px] rounded-[10px]">
								<div className="flex items-start self-stretch mx-[21px]">
									<button className="flex flex-col shrink-0 items-start bg-[#CDDDFC] text-left py-[15px] px-[18px] mr-[21px] rounded-[10px] border-0"
										onClick={()=>alert("Pressed!")}>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/x51mbmkt_expires_30_days.png"} 
											className="w-8 h-[38px] object-fill"
										/>
									</button>
									<div className="flex flex-1 flex-col items-start mt-[7px] mr-[41px] gap-[18px]">
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/c3cxwrdc_expires_30_days.png"} 
							...
							<div className="flex flex-1 flex-col items-start bg-white py-6 mr-3.5 gap-[5px] rounded-[10px]">
								<div className="flex items-start self-stretch ml-[25px] mr-[13px]">
									<button className="flex flex-col shrink-0 items-start bg-[#CAEBC3] text-left py-[13px] px-3 mr-[21px] rounded-[10px] border-0"
										onClick={()=>alert("Pressed!")}>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/5a6992gr_expires_30_days.png"} 
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/cum8vom2_expires_30_days.png"} 
										className="w-[53px] h-7 mt-[31px] object-fill"
									/>
								</div>
							...
							<div className="flex flex-1 flex-col items-center bg-white py-6 mr-[15px] gap-[5px] rounded-[10px]">
								<div className="flex items-start self-stretch mx-[21px]">
									<button className="flex flex-col shrink-0 items-start bg-[#F6DECA] text-left py-[15px] px-2.5 mr-[21px] rounded-[10px] border-0"
										onClick={()=>alert("Pressed!")}>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/ufzlp6mx_expires_30_days.png"} 
											className="w-[46px] h-[38px] object-fill"
										/>
									</button>
									<div className="flex flex-1 flex-col items-start mt-[7px] mr-[39px] gap-[18px]">
										<span className="text-[#100F0F] text-[13px] font-bold" >
											Active Incidents
										</span>
										<span className="text-[#141313] text-2xl font-bold" >
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/9b8a3q0j_expires_30_days.png"} 
										className="w-[53px] h-7 mt-[31px] object-fill"
									/>
								</div>
							...
							<div className="flex flex-1 flex-col items-start bg-white py-6 gap-[5px] rounded-[10px]">
								<div className="flex items-start self-stretch ml-[25px] mr-[13px]">
									<button className="flex flex-col shrink-0 items-start bg-[#E5D2FF] text-left py-[13px] px-3.5 mr-[21px] rounded-[10px] border-0"
										onClick={()=>alert("Pressed!")}>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/sdulslrg_expires_30_days.png"} 
											className="w-[39px] h-[42px] object-fill"
										/>
									</button>
									<div className="flex flex-1 flex-col items-start mt-[7px] mr-[37px] gap-[18px]">
										<span className="text-[#100F0F] text-[13px] font-bold" >
											Noise Reduction
										</span>
										<span className="text-[#141313] text-2xl font-bold" >
									...
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/j6no530n_expires_30_days.png"} 
										className="w-[53px] h-7 mt-[31px] object-fill"
									/>
								</div>
								<span className="text-[#37C81A] text-[11px] ml-[130px]" >
						...
						<div className="flex items-center self-stretch mb-4 mx-[3px]">
							<div className="flex flex-1 flex-col items-start bg-white pt-[7px] mr-[71px] rounded-[10px]">
								<div className="flex items-start self-stretch mb-[11px] mx-[25px]">
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/glsxqk6e_expires_30_days.png"} 
								...
								<div className="flex items-start self-stretch relative mx-[22px]">
									<div className="flex flex-col shrink-0 items-start mt-[18px] mr-[19px] gap-[27px]">
										<span className="text-[#141313] text-[10px]" >
											400
										</span>
										<span className="text-[#141313] text-[10px]" >
									...
									<div className="flex flex-1 flex-col items-start relative">
										<div className="self-stretch bg-[#D3CFCF] h-[1px] absolute top-6 right-0 left-0">
										</div>
										...
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/1bpu6irj_expires_30_days.png"} 
											className="w-[638px] h-[163px] object-fill"
										/>
									</div>
									<div className="bg-[#D3CFCF] w-[635px] h-[1px] absolute bottom-[33px] right-[3px]">
									</div>
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/ojzbinqd_expires_30_days.png"} 
										className="w-[634px] h-[71px] absolute bottom-0 right-1 object-fill"
									/>
								</div>
								<div className="flex flex-col items-end self-stretch mb-[21px]">
									<div className="bg-[#D5CECE] w-[636px] h-[1px] mr-[25px]">
									</div>
								</div>
								<div className="flex items-center mb-[37px] ml-[43px]">
							...
							<div className="flex flex-col items-start bg-white w-[522px] pt-[34px] pl-[35px] pr-[15px] rounded-[10px]">
								...
								<div className="flex items-start self-stretch mb-[58px]">
									...
									<div className="flex flex-col shrink-0 items-center mt-[31px] mr-2 gap-[30px]">
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/vaovtgtr_expires_30_days.png"} 
											className="w-[11px] h-2.5 object-fill"
										/>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/znjnr6bv_expires_30_days.png"} 
											className="w-[11px] h-2.5 object-fill"
										/>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/iwre92dw_expires_30_days.png"} 
											className="w-[11px] h-2.5 object-fill"
										/>
										<img
											src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/2557g564_expires_30_days.png"} 
											className="w-[11px] h-2.5 object-fill"
										/>
									</div>
						...
						<div className="flex items-center self-stretch mb-[19px] mx-[3px] gap-5">
							<div className="flex flex-1 flex-col bg-white py-[22px] gap-4 rounded-[10px] border border-solid border-[#5D88FF]">
								<div className="flex items-center self-stretch mx-8">
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/vlqsc3ds_expires_30_days.png"} 
								...
								<div className="flex flex-col items-start self-stretch bg-[#EDF3FF] pt-2.5 mx-[17px] rounded-[10px]">
									...
									<div className="flex items-center mb-1.5 ml-2">
										<div className="flex shrink-0 items-center bg-[#FFBFBFB8] p-[7px] mr-[54px] gap-[7px] rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/mw8q4r68_expires_30_days.png"} 
									...
									<div className="flex items-center mb-1.5 ml-2">
										<div className="flex shrink-0 items-center bg-[#F7C9A3B8] p-[7px] mr-[71px] gap-[7px] rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/bpb5btew_expires_30_days.png"} 
												className="w-[9px] h-[9px] object-fill"
											/>
									...
									<div className="flex items-center mb-[7px] ml-2">
										<div className="flex shrink-0 items-center bg-[#F8E9A3B8] py-2 px-[7px] mr-[53px] gap-1.5 rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/shniyczi_expires_30_days.png"} 
												className="w-[9px] h-[9px] object-fill"
											/>
									...
									<div className="flex items-center mb-[7px] ml-2">
										<div className="flex shrink-0 items-center bg-[#CDDDFCB8] p-[7px] mr-20 gap-[5px] rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/0zlfa962_expires_30_days.png"} 
												className="w-[9px] h-[9px] object-fill"
											/>
									...
									<div className="flex items-center mb-[7px] ml-2">
										<div className="flex shrink-0 items-center bg-[#F7C9A3B8] p-[7px] mr-[71px] gap-1.5 rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/42tkaoa2_expires_30_days.png"} 
												className="w-[9px] h-[9px] object-fill"
											/>
											<span className="text-[#FF9D4C] text-xs" >
												High
							...
							<div className="flex flex-1 flex-col bg-white py-[18px] gap-[18px] rounded-[10px] border border-solid border-[#5D88FF]">
								<div className="flex items-start self-stretch ml-[19px] mr-[33px]">
									<img
										src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/how2wzk6_expires_30_days.png"} 
								...
								<div className="self-stretch bg-[#EDF3FF] py-[9px] mx-[7px] rounded-[10px]">
									<div className="flex items-center self-stretch mb-5 ml-4 mr-7">
									...
									<div className="flex items-start self-stretch mb-[7px] ml-[9px] mr-[35px]">
										<div className="flex shrink-0 items-center bg-[#FFBFBFB8] py-[9px] px-1.5 mr-[53px] gap-1.5 rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/velrkhk1_expires_30_days.png"} 
									...
									<div className="flex items-start self-stretch mb-[7px] ml-[9px] mr-[38px]">
										<div className="flex shrink-0 items-center bg-[#F7C9A3B8] py-[9px] px-1.5 mr-[70px] gap-[5px] rounded-[10px]">
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/2ae57k0u_expires_30_days.png"} 
												className="w-[11px] h-3 object-fill"
											/>
											<span className="text-[#FF9D4C] text-xs" >
												High
									...
									<div className="flex items-center self-stretch mb-2 ml-[9px] mr-10">
										<button className="flex shrink-0 items-center bg-[#F8E9A3B8] text-left py-[9px] px-1.5 mr-[52px] gap-[5px] rounded-[10px] border-0"
											onClick={()=>alert("Pressed!")}>
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/mkjyf55p_expires_30_days.png"} 
												className="w-[11px] h-3 object-fill"
											/>
											<span className="text-[#A38605] text-xs" >
												Medium
									...
									<div className="flex items-center self-stretch ml-[9px] mr-10">
										<button className="flex shrink-0 items-center bg-[#CDDDFCB8] text-left py-[9px] px-1.5 mr-[79px] gap-[5px] rounded-[10px] border-0"
											onClick={()=>alert("Pressed!")}>
											<img
												src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/0p1r7hxh_expires_30_days.png"} 
												className="w-[11px] h-3 object-fill"
											/>
											<span className="text-[#5D88FF] text-xs" >
												Low
						...
						<div className="flex items-center self-stretch bg-white py-3.5 px-[26px] mx-[3px] rounded-[10px]">
							<button className="flex flex-col shrink-0 items-start bg-[#CDDDFC] text-left py-2.5 px-[21px] mr-[22px] rounded-[10px] border-0"
								onClick={()=>alert("Pressed!")}>
								<img
									src={"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/yonId6NjXU/hyz66mmg_expires_30_days.png"} 
